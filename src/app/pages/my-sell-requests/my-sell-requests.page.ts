...
@Component({
    selector: 'app-my-sell-requests',
    templateUrl: './my-sell-requests.page.html',
    styleUrls: ['./my-sell-requests.page.scss'],
})
export class MySellRequestsPage implements OnInit {
    ...
    getRequests() {
        ...
        if (this.lastPage == false) {
            ...
            this.sellRequestService.getByUser(this.languageService.selected, this.page, this.limit).subscribe(res => {
